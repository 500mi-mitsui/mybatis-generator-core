...
public abstract class IntrospectedTable {
    ...
    protected void calculateXmlAttributes() {
        ...
        setInsertSelectiveStatementId("insert");   // insertSelective -> insert
        setInsertBatchStatementId("insertBatch");
        setInsertBatchSelectiveStatementId("insertBatchSelective");
        setSelectAllStatementId("selectAll"); //$NON-NLS-1$
        setSelectByExampleStatementId("selectByExample"); //$NON-NLS-1$
        //add begin
        setDeleteByIdStatementId("delete");
        setSelectOneByIdStatementId("selectOneById"); //$NON-NLS-1$
        setSelectListStatementId("selectList"); //$NON-NLS-1$
        setSelectListCountStatementId("selectListCount"); //$NON-NLS-1$
        //add end
        ...
        setDataWhereClauseId("Data_Where_Clause");
        setDataWherePlusId("Data_Where_Plus");
    ...
    public void setDataWhereClauseId(String s) {
        internalAttributes.put(InternalAttribute.ATTR_DATA_WHERE_CLAUSE_ID, s);
    }

    public String getDataWhereClauseId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_DATA_WHERE_CLAUSE_ID);
    }

    public void setDataWherePlusId(String s) {
        internalAttributes.put(InternalAttribute.ATTR_DATA_WHERE_PLUS_ID, s);
    }

    public String getDataWherePlusId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_DATA_WHERE_PLUS_ID);
    }
    ...
    public String getSelectOneByIdStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_SELECT_ONE_BY_ID_STATEMENT_ID);
    }

    public void setSelectOneByIdStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_SELECT_ONE_BY_ID_STATEMENT_ID, s);
    }
    ...
    public String getSelectListCountStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_SELECT_LIST_COUNT_STATEMENT_ID);
    }

    public void setSelectListCountStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_SELECT_LIST_COUNT_STATEMENT_ID, s);
    }
    ...
    public String getDeleteByIdStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_DELETE_BY_ID_STATEMENT_ID);
    }

    public void setDeleteByIdStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_DELETE_BY_ID_STATEMENT_ID, s);
    }
    ...
    protected enum InternalAttribute {
        ...
        /**
         * The attr delete by id statement id.
         */
        ATTR_DELETE_BY_ID_STATEMENT_ID,
        ...
        ATTR_SELECT_ONE_BY_ID_STATEMENT_ID,

        ATTR_SELECT_LIST_STATEMENT_ID,

        ATTR_SELECT_LIST_COUNT_STATEMENT_ID,
        ...
        ATTR_DATA_WHERE_CLAUSE_ID,

        ATTR_DATA_WHERE_PLUS_ID,
