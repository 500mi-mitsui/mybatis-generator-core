...
public abstract class AbstractXmlElementGenerator extends AbstractGenerator {
    ...
    //Data_Where_Clause
    protected XmlElement getDataWhereClauseElement() {
        XmlElement answer = new XmlElement("include"); //$NON-NLS-1$
        answer.addAttribute(new Attribute("refid", //$NON-NLS-1$
                introspectedTable.getDataWhereClauseId()));
        return answer;
    }
    //Data_Where_Plus
    protected XmlElement getDataWherePlusElement() {
        XmlElement answer = new XmlElement("include"); //$NON-NLS-1$
        answer.addAttribute(new Attribute("refid", //$NON-NLS-1$
                introspectedTable.getDataWherePlusId()));
        return answer;
    }
