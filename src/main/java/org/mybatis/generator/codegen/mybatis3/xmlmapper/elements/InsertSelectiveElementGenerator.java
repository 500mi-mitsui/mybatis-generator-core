...
public class InsertSelectiveElementGenerator extends
    ...
    public void addElements(XmlElement parentElement) {
        ...
        IntrospectedColumn iColumn = introspectedTable.getColumn("id");
        answer.addAttribute(new Attribute("useGeneratedKeys", "true")); //$NON-NLS-1$ //$NON-NLS-2$
        answer.addAttribute(new Attribute("keyProperty", iColumn.getJavaProperty())); //$NON-NLS-1$
        answer.addAttribute(new Attribute("keyColumn", iColumn.getActualColumnName())); //$NON-NLS-1$

//        todo check here code
...
//            }
//        }
        GeneratedKey gk = new GeneratedKey("id", "SELECT LAST_INSERT_ID() AS id" , true, "BIGINT");
        answer.addElement(getSelectKey(iColumn, gk));
