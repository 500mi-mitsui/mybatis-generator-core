...
//        addSelectByExampleWithoutBLOBsElement(answer);
        addSelectListWithoutBLOBsElement(answer);
        addSelectListCountWithoutBLOBsElement(answer);
        addSelectOneByIdWithoutBLOBsElement(answer);
...
//        addUpdateByExampleWithoutBLOBsElement(answer);
        ...
        addDataWhereClauseElement(answer);
        addDataWherePlusElement(answer);
...
//        addMyBatis3UpdateByExampleWhereClauseElement(answer);
    ...
    protected void addSelectOneByIdWithoutBLOBsElement(
            XmlElement parentElement) {
        if (introspectedTable.getRules().generateSelectOneByIdWithoutBLOBs()) {
            AbstractXmlElementGenerator elementGenerator = new SelectOneByIdWithoutBLOBsElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }

    protected void addSelectListWithoutBLOBsElement(
            XmlElement parentElement) {
        if (introspectedTable.getRules().generateSelectListWithoutBLOBs()) {
            AbstractXmlElementGenerator elementGenerator = new SelectListWithoutBLOBsElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }

    protected void addSelectListCountWithoutBLOBsElement(
            XmlElement parentElement) {
        if (introspectedTable.getRules().generateSelectListCountWithoutBLOBs()) {
            AbstractXmlElementGenerator elementGenerator = new SelectListCountWithoutBLOBsElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
    ...
    protected void addDataWhereClauseElement(
            XmlElement parentElement) {
        //introspectedTable.getRules().generateDataWhereClause()
        if (true) {
            AbstractXmlElementGenerator elementGenerator = new DataWhereClauseElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }

    protected void addDataWherePlusElement(
            XmlElement parentElement) {
        if (true) {
            AbstractXmlElementGenerator elementGenerator = new DataWherePlusElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
