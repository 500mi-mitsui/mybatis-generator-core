...
public interface Rules {
    ...
    boolean generateDataWhereClause();
    ...
    boolean generateSelectOneByIdWithoutBLOBs();

    boolean generateSelectListWithoutBLOBs();

    boolean generateSelectListCountWithoutBLOBs();
