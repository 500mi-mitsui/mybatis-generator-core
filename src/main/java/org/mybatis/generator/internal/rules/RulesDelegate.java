...
public class RulesDelegate implements Rules {
    ...
    public boolean generateDeleteById() {
        return rules.generateDeleteById();
    }
    ...
    public boolean generateSelectOneByIdWithoutBLOBs() {
        return rules.generateSelectOneByIdWithoutBLOBs();
    }

    public boolean generateSelectListWithoutBLOBs() {
        return rules.generateSelectListWithoutBLOBs();
    }

    public boolean generateSelectListCountWithoutBLOBs() {
        return rules.generateSelectListCountWithoutBLOBs();
    }
    ...
    public boolean generateDataWhereClause() {
        return rules.generateDataWhereClause();
    }
