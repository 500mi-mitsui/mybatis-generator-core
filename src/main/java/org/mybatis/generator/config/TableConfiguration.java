...
public class TableConfiguration extends PropertyHolder {
    ...
    /** The select one by id statement enabled. */
    private boolean selectOneByIdStatementEnabled;

    /** The select list by id statement enabled. */
    private boolean selectListStatementEnabled;

    /** The select list count by id statement enabled. */
    private boolean selectListCountStatementEnabled;
    ...
    /** The delete by id statement enabled. */
    private boolean deleteByIdStatementEnabled;
    ...
    private boolean dataWhereClauseStatementEnabled;
    ...
    public TableConfiguration(Context context) {
        ...
        selectOneByIdStatementEnabled = true;
        selectListStatementEnabled = true;
        selectListCountStatementEnabled = true;
        updateByPrimaryKeyStatementEnabled = true;
        deleteByPrimaryKeyStatementEnabled = true;
        deleteByExampleStatementEnabled = true;
        deleteByIdStatementEnabled = true;
        countByExampleStatementEnabled = true;
        updateByExampleStatementEnabled = true;
        dataWhereClauseStatementEnabled = true;
    }
    ...
    public boolean isDeleteByIdStatementEnabled() {
        return deleteByIdStatementEnabled;
    }

    public void setDeleteByIdStatementEnabled(
            boolean deleteByIdStatementEnabled) {
        this.deleteByIdStatementEnabled = deleteByIdStatementEnabled;
    }
    ...
    public boolean isSelectOneByIdStatementEnabled() {
        return selectOneByIdStatementEnabled;
    }

    public void setSelectOneByIdStatementEnabled(
            boolean selectOneByIdStatementEnabled) {
        this.selectOneByIdStatementEnabled = selectOneByIdStatementEnabled;
    }

    public boolean isSelectListStatementEnabled() {
        return selectListStatementEnabled;
    }

    public void setSelectListStatementEnabled(
            boolean selectListStatementEnabled) {
        this.selectListStatementEnabled = selectListStatementEnabled;
    }

    public boolean isSelectListCountStatementEnabled() {
        return selectListCountStatementEnabled;
    }

    public void setSelectListCountStatementEnabled(
            boolean selectListCountStatementEnabled) {
        this.selectListCountStatementEnabled = selectListCountStatementEnabled;
    }
    ...
    public XmlElement toXmlElement() {
        ...
        if (!selectOneByIdStatementEnabled) {
            xmlElement.addAttribute(new Attribute(
                    "enableSelectOneById", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
    ...
    public boolean isDataWhereClauseStatementEnabled() {
        return dataWhereClauseStatementEnabled;
    }

    public void setDataWhereClauseStatementEnabled(
            boolean dataWhereClauseStatementEnabled) {
        this.dataWhereClauseStatementEnabled = dataWhereClauseStatementEnabled;
    }
