...
此处引用的是mybatis-generator-maven-plugin ，在本地maven仓库（Repository）中找到mybatis-generator-maven-plugin jar包，
解压打开plugin.xml 查看其引用的核心包：
...
从配置文件中可以看到插件引用的核心包是org.mybatis.generator.1.3.5 ，在本地maven仓库（Repository）中找到此jar包所在的路径，
用新生成的jar包修改成同名（名称对插件的功能没有影响）后替换即可；

替换mybatis-generator-core的包
/Users/mitsui/Documents/workspace/repository/org/mybatis/generator/mybatis-generator-core/1.3.5/mybatis-generator-core-1.3.5.jar